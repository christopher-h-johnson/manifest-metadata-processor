...
public class MetadataBuilderVersion3 {
    private MetadataUtilsVersion3 metadataUtils = new MetadataUtilsVersion3();
    ...
    public MetadataUtilsVersion3 build() {
    ...
    public MetadataUtilsVersion3 buildMetadataFromPPNApi(String ppn) {
    ...
    public MetadataUtilsVersion3 buildMetadataFromURNApi(String urn) {
